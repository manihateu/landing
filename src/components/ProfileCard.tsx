...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, #4a9fd466 0%, #b8dff544 100%)";
...
function ProfileCardComponent({
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color":
          behindGlowColor ?? "rgba(126, 200, 232, 0.55)",
  ...
  const handleMiniImageError = (event: SyntheticEvent<HTMLImageElement>) => {
    event.currentTarget.style.opacity = "0.5";
    if (avatarUrl) event.currentTarget.src = avatarUrl;
  };
